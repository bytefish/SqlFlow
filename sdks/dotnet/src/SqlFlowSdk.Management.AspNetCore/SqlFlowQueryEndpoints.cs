...
/// <summary>
/// Provides extension methods to register SqlFlow Query API endpoints as ASP.NET Core Minimal APIs.
/// </summary>
public static class SqlFlowQueryEndpoints
{
    /// <summary>
    /// Maps all SqlFlow Query API endpoints under a configurable route prefix (default: /api/sqlflow-query).
    /// </summary>
    public static IEndpointRouteBuilder MapSqlFlowQueryEndpoints(
        this IEndpointRouteBuilder routes,
        string routePrefix = "/api/sqlflow-query")
    {
        var group = routes.MapGroup(routePrefix)
                          .WithTags("SqlFlow Query API");

        group.MapGet("/stats", async (ISqlFlowQueryService dashboard, CancellationToken ct) =>
        ...
        group.MapGet("/throughput", async (ISqlFlowQueryService dashboard, int? windowSeconds, CancellationToken ct) =>
        {
        ...
        group.MapGet("/latency-percentiles", async (ISqlFlowQueryService dashboard, string? queueName, CancellationToken ct) =>
        ...
        group.MapGet("/health", async (ISqlFlowQueryService dashboard, string queueName, CancellationToken ct) =>
        ...
        group.MapGet("/workers", async (ISqlFlowQueryService dashboard, CancellationToken ct) =>
        ...
        group.MapGet("/wait-times", async (ISqlFlowQueryService dashboard, int? limit, CancellationToken ct) =>
        ...
        group.MapGet("/hotspots/failures", async (ISqlFlowQueryService dashboard, int? lookbackSeconds, int? limit, CancellationToken ct) =>
        {
        ...
        group.MapGet("/active-waits", async (ISqlFlowQueryService dashboard, int? limit, CancellationToken ct) =>
        ...
        group.MapGet("/backlog", async (ISqlFlowQueryService dashboard, int? limit, CancellationToken ct) =>
        ...
        group.MapGet("/hotspots/retries", async (ISqlFlowQueryService dashboard, int? limit, CancellationToken ct) =>
        ...
        group.MapGet("/upcoming-wakeups", async (ISqlFlowQueryService dashboard, int? limit, CancellationToken ct) =>
        ...
        group.MapGet("/slow-tasks", async (ISqlFlowQueryService dashboard, int? limit, CancellationToken ct) =>
        ...
        group.MapGet("/failed-tasks", async (ISqlFlowQueryService dashboard, int? limit, CancellationToken ct) =>
        ...
        group.MapGet("/tasks/{queueName}/{taskId}", async (ISqlFlowQueryService dashboard, string queueName, string taskId, CancellationToken ct) =>
        {
        ...
        group.MapPost("/tasks/search", async (ISqlFlowQueryService dashboard, TaskSearchFilter filter, CancellationToken ct) =>
