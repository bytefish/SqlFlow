...
export const TRANSLATIONS_EN: DashboardTranslations = {
  ...
  subtitle: 'Enterprise workflow telemetry console',
...
export const TRANSLATIONS_DE: DashboardTranslations = {
  title: 'SqlFlow System Explorer',
  subtitle: 'Enterprise Workflow-Telemetrie-Konsole',
  autoRefresh: 'Auto-Refresh (10s)',
...
export class AppSettingsService {
  ...
  async load(): Promise<void> {
    ...
    if (!settings.sqlFlowDashboardApiUrl) {
      throw new Error('Missing setting: sqlFlowDashboardApiUrl');
    }
  ...
  get sqlFlowDashboardApiUrl(): string {
    ...
    return settings.sqlFlowDashboardApiUrl;
  }
}

@Injectable({ providedIn: 'root' })
export class SqlFlowDashboardService {
...
export class App implements OnInit, OnDestroy {
  readonly service = inject(SqlFlowDashboardService);
